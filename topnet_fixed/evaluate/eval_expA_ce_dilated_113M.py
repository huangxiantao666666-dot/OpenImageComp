"""Evaluate expA_ce_dilated_113M on the OPA test set."""
import os, sys, json, torch
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), '..'))
from eval_shared import evaluate_model, load_fixed, DataLoader, PlacementDataset

DATA_DIR = './data/data'
WEIGHT  = './checkpoints/expA_ce_dilated_113M/stage2_best.pth'
DEVICE  = 'cuda' if torch.cuda.is_available() else 'cpu'
NAME    = 'expA_ce_dilated_113M'
RESULT_KEY = 'expA_CE_dilated_113M'
...
model, mtype = load_fixed('ObPlaNet_resnet18_113M', WEIGHT, DEVICE)
