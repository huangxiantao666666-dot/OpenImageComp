"""Evaluate expC_focal_full_113M on the OPA test set."""
...
WEIGHT  = os.path.join(CKPT_DIR, 'expC_focal_full_113M/stage2_best.pth')
DEVICE  = 'cuda' if torch.cuda.is_available() else 'cpu'
NAME    = 'expC_focal_full_113M'
RESULT_KEY = 'expC_focal_full_113M'
...
if 'fixed' == 'buggy':
    ...
    model, mtype = load_fixed('ObPlaNet_resnet18_keypoint_113M', WEIGHT, DEVICE)
