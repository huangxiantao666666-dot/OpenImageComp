"""Evaluate expA_ce_dilated on the OPA test set."""
...
WEIGHT  = os.path.join(CKPT_DIR, 'expA_ce_dilated/stage2_best.pth')
DEVICE  = 'cuda' if torch.cuda.is_available() else 'cpu'
NAME    = 'expA_ce_dilated'
RESULT_KEY = 'expA_CE_dilated'
...
if 'fixed' == 'buggy':
    ...
    model, mtype = load_fixed('ObPlaNet_resnet18', WEIGHT, DEVICE)
