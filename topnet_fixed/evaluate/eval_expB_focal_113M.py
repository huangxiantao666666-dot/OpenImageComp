"""Evaluate expB_focal_113M on the OPA test set."""
...
WEIGHT  = os.path.join(CKPT_DIR, 'expB_focal_113M/stage2_best.pth')
DEVICE  = 'cuda' if torch.cuda.is_available() else 'cpu'
NAME    = 'expB_focal_113M'
RESULT_KEY = 'expB_focal_partial_113M'
